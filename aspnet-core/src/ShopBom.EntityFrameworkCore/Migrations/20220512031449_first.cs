        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdProductType = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProducts_AppColors_IdColor",
                        column: x => x.IdColor,
                        principalTable: "AppColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppProducts_AppProductTypes_IdProductType",
                        column: x => x.IdProductType,
                        principalTable: "AppProductTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppProducts_AppSizes_IdSize",
                        column: x => x.IdSize,
                        principalTable: "AppSizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIntermediaryProductTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppIntermediaryProductTypes_AppProducts_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "AppProducts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppIntermediaryProductTypes_AppProductTypes_IdProductType",
                        column: x => x.IdProductType,
                        principalTable: "AppProductTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProductColors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppProductColors_AppColors_IdColor",
                        column: x => x.IdColor,
                        principalTable: "AppColors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppProductColors_AppProducts_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "AppProducts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProductPromotions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppProductPromotions_AppColors_IdPromotion",
                        column: x => x.IdPromotion,
                        principalTable: "AppColors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppProductPromotions_AppProducts_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "AppProducts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppProductSizes_AppColors_IdSize",
                        column: x => x.IdSize,
                        principalTable: "AppColors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppProductSizes_AppProducts_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "AppProducts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppPromotions_AppProducts_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "AppProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppIntermediaryProductTypes_IdProductType",
                table: "AppIntermediaryProductTypes",
                column: "IdProductType");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductColors_IdColor",
                table: "AppProductColors",
                column: "IdColor");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductColors_IdProduct",
                table: "AppProductColors",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductPromotions_IdProduct",
                table: "AppProductPromotions",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductPromotions_IdPromotion",
                table: "AppProductPromotions",
                column: "IdPromotion");

            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_IdColor",
                table: "AppProducts",
                column: "IdColor");

            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_IdProductType",
                table: "AppProducts",
                column: "IdProductType");

            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_IdSize",
                table: "AppProducts",
                column: "IdSize");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductSizes_IdProduct",
                table: "AppProductSizes",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductSizes_IdSize",
                table: "AppProductSizes",
                column: "IdSize");

            migrationBuilder.CreateIndex(
                name: "IX_AppPromotions_IdProduct",
                table: "AppPromotions",
                column: "IdProduct");
        }
